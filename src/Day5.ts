export const dataDay5try = [[[0, 9], [5, 9]],
[[8, 0], [0, 8]],
[[9, 4], [3, 4]],
[[2, 2], [2, 1]],
[[7, 0], [7, 4]],
...
export const getLinesOverlap = (data: any) => {
    const map: any = [];
    for (let i = 0; i <= 999; i++) {
        const row: any = []
        for (let j = 0; j <= 999; j++) {
...
export const getLinesOverlapWithDiagonal = (data: any) => {
    const map: any = [];
    for (let i = 0; i <= 9; i++) {
        const row: any = []
        for (let j = 0; j <= 9; j++) {
    ...
    for (const line of data) {
        ...
        if (line[0][0] !== line[1][0] && line[0][1] !== line[1][1]) { // diagonal
